...
function createBot() {
    const bot = mineflayer.createBot({
        host: 'Scapleois.aternos.me',
        port: 17760,
        username: 'STAFF SCAPLEOSIS',
        version: false, // Biarkan auto-detect versi
        auth: 'offline' // Sangat penting untuk server cracked/Aternos gratis
    });
